export default {
  ...
  properties: {
    $schema: {
      ...
      type: 'string',
      enum: ['https://docs.oasis-open.org/csaf/csaf/v2.1/schema/provider.json'],
      format: 'uri',
    },
    canonical_url: {
      title: 'Canonical URL',
    ...
    role: {
      ...
      enum: ['csaf_publisher', 'csaf_provider', 'csaf_trusted_provider'],
    },
  },
  additionalProperties: false,
}
